...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden flex items-center py-8">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 items-center">
          {/* Left Content */}
          <div className="text-white space-y-3 lg:space-y-4 order-1 lg:order-1 text-center lg:text-left">
            {/* Trust Badge */}
            <div className="inline-flex items-center bg-blue-600 px-4 py-2 rounded-full text-sm font-semibold">
            ...
            <div className="space-y-2 text-center lg:text-left">
              ...
              <p className="text-sm sm:text-base md:text-lg text-gray-300 leading-relaxed max-w-2xl hidden lg:block">
            ...
            {/* Professional Features - Compact - Hidden on mobile, shown after form */}
            <div className="hidden lg:grid grid-cols-2 gap-2 lg:gap-2">
              ...
              <div className="flex items-center space-x-2 bg-white/10 backdrop-blur-sm rounded-lg p-2">
                ...
                <div>
                  <div className="text-white font-semibold text-xs">Nationwide</div>
                  <div className="text-xs text-gray-400">50 States</div>
                </div>
              </div>
            ...
            {/* Call to Action - Compact - Hidden on mobile, shown after form */}
            <div className="hidden lg:block bg-[#122E5F]/20 backdrop-blur-sm border border-[#2563eb]/30 rounded-xl p-3 lg:p-3">
              <div className="flex items-center justify-center mb-1">
                <Phone className="h-5 w-5 text-[#2563eb] mr-2" />
                <span className="text-[#2563eb] font-bold text-sm">Call Now</span>
              </div>
              ...
              <div className="space-y-3">
                ...
                {currentStep === 1 && (
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2.5 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-[#2563eb] focus:border-[#2563eb] text-gray-900 placeholder-gray-500 transition-all duration-300 text-sm"
                  ...
                  <div className="space-y-3">
                    <div className="grid grid-cols-2 gap-2">
                      <div>
                        ...
                        <input
                          type="text"
                          placeholder="John"
                          className="w-full px-2 py-2 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-[#2563eb] focus:border-[#2563eb] text-gray-900 placeholder-gray-500 transition-all duration-300 text-sm"
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-[#2563eb] focus:border-[#2563eb] text-gray-900 placeholder-gray-500 transition-all duration-300 text-sm"
                ...
                {currentStep === 3 && (
                  <div className="space-y-3">
                    ...
                    {/* What Happens Next */}
                    <div className="bg-blue-50 border border-[#2563eb]/20 rounded-lg p-3">
                      <h3 className="text-[#122E5F] font-bold mb-3 flex items-center text-sm">
                ...
                <div className="flex space-x-2 mt-4">
                  {currentStep > 1 && (
                    <button
                      onClick={prevStep}
                      className="flex-1 bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold py-2.5 px-3 rounded-lg transition-all duration-300 flex items-center justify-center space-x-2 text-sm"
                    >
                  ...
                  <button
                    ...
                    className="flex-1 bg-[#122E5F] hover:bg-[#0f2347] disabled:bg-gray-400 disabled:cursor-not-allowed text-white font-bold py-2.5 px-3 rounded-lg transition-all duration-300 flex items-center justify-center space-x-2 text-sm"
                  >
                    {currentStep === 3 ? (
                      <>
          ...
          {/* Mobile Content - Shows after form on mobile only */}
          <div className="lg:hidden text-white space-y-4 order-3">
            {/* Mobile Description */}
